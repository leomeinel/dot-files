  ...
  home = {
    ...
    activation = {
      common-home-gui = lib.hm.dag.entryAfter [ "writeBoundary" ] ''
        ...
        run /usr/bin/rsync -r --delete /usr/share/fonts/ ${config.xdg.dataHome}/fonts
        ...
        run /usr/bin/rsync -r --delete /usr/share/icons/ ${config.xdg.dataHome}/icons
        ...
        run /usr/bin/rsync -r --delete /usr/share/themes/ ${config.xdg.dataHome}/themes
